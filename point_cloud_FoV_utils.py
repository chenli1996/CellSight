...
def get_pcd_data_FSVVD_filtered(point_cloud_name='Chatting', trajectory_index=0):
    FSVVD_file_path = f'../point_cloud_data/processed_FSVVD/FSVVD_300/{point_cloud_name}/Filtered/'
    pcd = o3d.io.read_point_cloud(FSVVD_file_path + f'{trajectory_index%300}_binary.ply')
    return pcd
